        ...
        <aside id="bh-user-sidebar" class="fixed inset-y-0 left-0 z-50 w-72 -translate-x-full md:translate-x-0 md:static md:z-auto md:flex md:w-68 flex-col border-r border-slate-800/80 bg-slate-950/95 transition-transform duration-200" style="background-color: var(--bh-surface-2);">
            ...
            <nav class="flex-1 px-4 py-4 space-y-1 text-base md:text-lg">
                ...
                <a href="{{ route('user.reports.index') }}"
                    class="bh-nav-link block rounded-lg px-3 py-2 pl-7 text-sm md:text-base font-medium {{ request()->routeIs('user.reports.*') ? 'bh-nav-link-active' : 'text-slate-300 hover:bg-slate-900 hover:text-white border border-transparent' }}">My Reports</a>
                ...
                <a href="{{ route('user.chats.doctors') }}"
                    class="bh-nav-link block rounded-lg px-3 py-2 pl-7 text-sm md:text-base font-medium {{ request()->routeIs('user.chats.doctors*') ? 'bh-nav-link-active' : 'text-slate-300 hover:bg-slate-900 hover:text-white border border-transparent' }}">With Doctors</a>
                <a href="{{ route('user.chats.group') }}"
                    class="bh-nav-link block rounded-lg px-3 py-2 pl-7 text-sm md:text-base font-medium {{ request()->routeIs('user.chats.group*') ? 'bh-nav-link-active' : 'text-slate-300 hover:bg-slate-900 hover:text-white border border-transparent' }}">All Doctors Group</a>
            </nav>
        </aside>
