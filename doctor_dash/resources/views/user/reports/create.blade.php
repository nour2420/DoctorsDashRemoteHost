...
@section('header', 'Upload new report')

@section('content')
    <div class="max-w-xl mx-auto rounded-2xl bg-slate-900/80 border border-slate-700/70 p-6 text-xs">
        <h2 class="text-base md:text-lg font-semibold mb-4">Upload new report</h2>
        ...
        <form action="{{ route('user.reports.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            <div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addBtn.addEventListener('click', function() {
                ...
                input.className = 'w-full text-xs text-slate-200 file:mr-3 file:rounded-md file:border-0 file:bg-amber-400 file:px-3 file:py-1.5 file:text-xs file:font-semibold file:text-black hover:file:bg-amber-300';
